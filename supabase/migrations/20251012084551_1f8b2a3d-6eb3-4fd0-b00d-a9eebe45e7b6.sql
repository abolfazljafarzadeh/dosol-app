-- Fix currentWeek calculation to use Saturday as week start (Persian calendar)
...
BEGIN
  ...
  -- Calculate Saturday as week start (Persian calendar)
  -- In PostgreSQL, EXTRACT(DOW) returns: Sunday=0, Monday=1, ..., Saturday=6
  -- We want Saturday as day 0, so we adjust: (DOW + 1) % 7
